...
import '../entity/measurement_entity.dart';
...
class _MeasurementsPageState extends State<MeasurementsPage> with AutomaticKeepAliveClientMixin<MeasurementsPage>{
                ...
                child: Slidable(
                    ...
                    dismissible: DismissiblePane(
                        onDismissed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text(elements[index].title + 'rimossa'),
                  ...
                  child: Material(
                    ...
                    child: ListTile(
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text(elements[index].title + ' pressed!'),
                          ));
                        },
                        ...
                        trailing: Icon(elements[index].icon)),
                  ),
                )),
          );
        });
